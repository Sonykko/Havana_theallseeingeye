{% include "housekeeping/base/header.tpl" %}
  <body>
	...
	{% include "housekeeping/base/navigation_admin_tools.tpl" %}
     <h2 class="mt-4">Group Name Reports</h2>		
		...
		<form id="getAllReports" action="{{ site.sitePath }}/{{ site.housekeepingPath }}/admin_tools/groupname_reports_list" method="post">
		...
		{% endif %}			
			...
			<form id="processReportsForm" action="{{ site.sitePath }}/{{ site.housekeepingPath }}/admin_tools/groupname_reports_list" method="post">
