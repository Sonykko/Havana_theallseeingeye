{% include "housekeeping/base/header.tpl" %}
  <body>
	...
	{% include "housekeeping/base/navigation_admin_tools.tpl" %}
     <h2 class="mt-4">{{ site.siteName }} Motto Reports</h2>		
		...
		<form id="getAllReports" action="{{ site.sitePath }}/{{ site.housekeepingPath }}/admin_tools/motto_reports_list" method="post">
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						{% autoescape'html' %}
						<td>{{ contentReportsList.motto }}</td>
						{% endautoescape %}
		...
		{% endif %}			
			...
			<form id="processReportsForm" action="{{ site.sitePath }}/{{ site.housekeepingPath }}/admin_tools/motto_reports_list" method="post">
