			  ...
			  <form class="alert__tool__form" method="post">	
				...
				<div class="alert__tool__commonmessage">
					<select name="commonMessage" id="commonMessage">
						...
						<option value="{{ CFHTopics.getSanctionReasonDesc() }}">{{ CFHTopics.getSanctionReasonValue() }}</option>
						{% endfor %}
					</select>
				</div>								
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <td><a href="{{ site.sitePath }}/ase/habbo/es/housekeeping/extra/hobba/admin_tools/rooms/edit?id={{ remoteRoomKickLog.getUser() }}">{{ remoteRoomKickLog.getUser() }}</a></td>		
