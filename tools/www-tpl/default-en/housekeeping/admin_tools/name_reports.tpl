{% include "housekeeping/base/header.tpl" %}
  <body>
	...
	{% include "housekeeping/base/navigation_admin_tools.tpl" %}
     <h2 class="mt-4">{{ site.siteName }} Name Reports</h2>		
		...
		<form id="getAllReports" action="{{ site.sitePath }}/{{ site.housekeepingPath }}/admin_tools/name_reports_list" method="post">
		...
		{% endif %}			
			...
			<form id="processReportsForm" action="{{ site.sitePath }}/{{ site.housekeepingPath }}/admin_tools/name_reports_list" method="post">
			...
			<br/>
			<p><b>Note:</b> when you click "Process", {{ site.siteName }}s whose checkbox has been checked will be permanently banned. Other reports are ignored and deleted from database.</p>
		</div>				
		{% endif %}	
      </div>
    </div>
