...
('discord.widget.community.enabled', 'Set if the Discord widget is showed in community page', 'site'),
('discord.widget.id', 'Set the Discord widget ID', 'site'),
('discord.widget.me.enabled', 'Set if the Discord widget is showed in me page', 'site'),
