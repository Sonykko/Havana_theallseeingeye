...
public class HousekeepingUsersController {
    ...
    public static void imitate(WebConnection webConnection) {
        if (!webConnection.session().getBoolean(SessionUtil.LOGGED_IN_HOUSKEEPING)) {
            webConnection.redirect("/" + Routes.HOUSEKEEPING_DEFAULT_PATH);
            return;
        }

        Template tpl = webConnection.template("housekeeping/admin_tools/users_create");
    ...
    public static void search(WebConnection client) {
        ...
        Template tpl = client.template("housekeeping/admin_tools/users_search");
        tpl.set("housekeepingManager", HousekeepingManager.getInstance());
    ...
    public static void create(WebConnection client) {
        ...
        Template tpl = client.template("housekeeping/admin_tools/users_create");
        tpl.set("housekeepingManager", HousekeepingManager.getInstance());
    ...
    public static void edit(WebConnection client) {
        ...
        Template tpl = client.template("housekeeping/admin_tools/users_edit");
        tpl.set("housekeepingManager", HousekeepingManager.getInstance());
