...
import org.alexdev.http.controllers.housekeeping.moderation.*;
import org.alexdev.http.controllers.site.*;

public class Routes {
    public static String HOUSEKEEPING_PATH = "ase/habbo/es/housekeeping/extra/hobba";
    public static String HOUSEKEEPING_DEFAULT_PATH = "ase/housekeeping/es";
    ...
    public static void register() {
        ...
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/superban", HousekeepingBanApiController::superban);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/ban", HousekeepingBanApiController::banuser);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/mass_ban", HousekeepingBanApiController::massBanuser);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/mass_unban", HousekeepingBanApiController::massUnbanuser);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/kick", HousekeepingKickApiController::kickuser);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/alert", HousekeepingAlertApiController::alertuser);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/massalert", HousekeepingMassAlertApiController::massalert);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/mass_kick", HousekeepingKickApiController::massKickuser);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/cfh.pick", HousekeepingCFHApiController::cfhPickUp);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/cfh.reply", HousekeepingCFHApiController::cfhReply);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/cfh.block", HousekeepingCFHApiController::cfhBlock);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/cfh.follow", HousekeepingCFHApiController::cfhFollow);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/room.kick", HousekeepingRoomKickApiController::roomKick);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/give.badge", HousekeepingGiveBadgeApiController::giveBadge);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/groups/show_badge_editor", HousekeepingGroupsApiController::showBadgeEditor);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/api/groups/update_group_badge", HousekeepingGroupsApiController::updateGroupBadge);
        ...
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/mass_alert", HousekeepingMassAlertRCONController::massAlertRCON);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/alert", HousekeepingAlertRCONController::alertUserRCON);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/users/mod_tool", HousekeepingBanKickRCONController::banKickUserRCON);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/mass_ban", HousekeepingBanKickRCONController::massBanKickUserRCON);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/mass_unban", HousekeepingBanKickRCONController::massUnbanUserRCON);
        ...
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/give_badge", HousekeepingGiveBadgeRCONController::giveBadge);
        ...
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/room_kick", HousekeepingRoomKickRCONController::roomKickRCON);
        ...
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/guestbook_reports_list", HousekeepingGuestbookReportsController::guestbook_reports);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/games_ranks", HousekeepingGamesRanksController::games_ranks);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/admin_tools/hobba_logs", HousekeepingHobbaLogController::hobba_logs);
        ...
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/infobus_polls/create", HousekeepingInfobusController::create_polls);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/infobus_polls/delete", HousekeepingInfobusController::delete);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/infobus_polls/edit", HousekeepingInfobusController::edit);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/infobus_polls/view_results", HousekeepingInfobusController::view_results);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/infobus_polls/clear_results", HousekeepingInfobusController::clear_results);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/infobus_polls/send_poll", HousekeepingInfobusController::send_poll);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/infobus_polls/close_event", HousekeepingInfobusController::close_event);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/infobus_polls/door_status", HousekeepingInfobusController::door_status);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/articles", HousekeepingNewsController::articles);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/articles/create", HousekeepingNewsController::create);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/articles/delete", HousekeepingNewsController::delete);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/articles/edit", HousekeepingNewsController::edit);
        ...
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/room_badges", HousekeepingRoomBadgesController::badges);
        ...
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/campaign_management/botguide", HousekeepingBotGuideController::botguide);
    }
}
